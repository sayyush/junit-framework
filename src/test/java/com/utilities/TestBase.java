...
//        Create the HTML template using extent html reporter in the path
        extentHtmlReporter = new ExtentHtmlReporter(path);
                                                            // 39-44 satirlar bize empty reporter veriyor
...
//        connecting extent reports and extent html reporter
        // extent reports ve extent html reporter  ikisi ayri DAG onlari birlestiriyoruz
...
//        generate the report
    ...
    /*
    This method captures sscreenshot of the entire(tum) page
     */
